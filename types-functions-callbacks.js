...
var yetAnotherNum = doubleNum(5)

console.log(yetAnotherNum)
...
var minimum = function(numA, numB, numC, numD) {
	...
	if (numD < numC && numD < numA && numD < numB) {
   		 return numD;
	}
}
